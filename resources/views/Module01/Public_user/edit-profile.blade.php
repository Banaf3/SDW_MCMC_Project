...
@section('title', 'My Profile - VeriTrack')
...
<div class="profile-container">
    <div class="profile-header">
        <div class="profile-header-text">
            ...
            <p class="profile-subtitle">Manage your personal account information and preferences</p>
        </div>
        <div class="public-badge">
            <span class="role-indicator">Public User</span>
        </div>
    </div>
    ...
    <div class="profile-card">
        ...
        @endif
          <form id="profile-form" method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
            ...
            <div class="form-section profile-pic-section public-pic-section">
                ...
                <div class="profile-picture-container">
                    <div class="profile-pic-wrapper">
                        ...
                        @else
                            <div class="current-picture no-image public-avatar" id="profile-pic-display">
                    ...
                    <div class="upload-controls">
                        <div class="form-group">
                            <button type="button" class="custom-file-upload public-upload" onclick="triggerFileInput()">
                            ...
                            <div class="file-restrictions">Upload a nice photo of yourself. JPG, PNG, GIF. Max size: 2MB</div>
                        </div>
                    </div>
                </div>
            </div>
            
            <div class="form-section public-info-section">
            ...
            <div class="form-section public-contact-section">
                ...
                <div class="form-group">
                    ...
                    <span class="form-hint">Your contact phone number</span>
                </div>
                
                <div class="form-group">
                    <label for="address">Home Address</label>
                    <textarea name="address" id="address" class="form-control" rows="3" placeholder="Your home address">{{ $user->address ?? '' }}</textarea>
                    <span class="form-hint">Your residential address (optional)</span>
                </div>
            </div>
            
            <div class="form-actions public-actions">
                <button type="submit" class="btn btn-primary public-save-button">
                    <i class="save-icon">💾</i> Save My Profile
                </button>
...
.profile-title {
    background: linear-gradient(135deg, #f7971e 0%, #ffd32a 100%);
...
.custom-file-upload {
    ...
    background: linear-gradient(90deg, #f7971e 0%, #ffd32a 100%);
    color: white;
    border-radius: 6px;
    cursor: pointer;
    transition: all 0.3s;
...
function handleFileSelect(input) {
    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
            ...
            profilePicDisplay.classList.remove('no-image', 'public-avatar');
